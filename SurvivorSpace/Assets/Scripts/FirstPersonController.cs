...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour {
		...
		public Vector3 PlayerVelocity => _controller.velocity;
		...
		private void Rotation() {
			...
			if (inputDirection.magnitude >= 0.1f) {
				var targetAngle = Mathf.Atan2(inputDirection.x, inputDirection.z) * Mathf.Rad2Deg + _mainCamera.transform.eulerAngles.y;
				var angle = Mathf.SmoothDampAngle(transform.eulerAngles.y, targetAngle, ref _turnSmooth, .35f);
