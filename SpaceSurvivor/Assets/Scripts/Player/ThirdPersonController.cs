...
namespace StarterAssets  {
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Awake() {
            ...
            StarterAssetsInputs.AimEvent += AimEvent;
        }
        ...
        private void AimEvent(bool isAiming) {
            _sensitivity = isAiming ? AimlSensitivity : NormalSensitivity;
        }
